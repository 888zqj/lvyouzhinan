<script setup>
import {ref} from "vue";
import {Position, Expand, Close, Setting, HelpFilled,Message,House,Postcard,User,CirclePlus} from "@element-plus/icons-vue";
  ...
  <nav class="menu" :class="{ open: isMenuOpen }">
    ...
    <ul class="optionsBar">
      <li class="menuItem">
        ...
        <el-tooltip effect="dark" content="主页/热门城市推荐" placement="right">
          <RouterLink to="/" class="menuOption">
       <el-icon :size="25"><House /></el-icon>
            <h5 class="menuText" :class="{ open2: isMenuOpen }">主页/热门城市推荐</h5>
          </RouterLink>
        </el-tooltip>
      </li>
       ...
       <li class="menuItem">
     <el-tooltip effect="dark" content="帖子专区" placement="right">
          <RouterLink to="/explore" class="menuOption">
            
           <el-icon :size="25"><Postcard /></el-icon>
            <h5 class="menuText" :class="{ open2: isMenuOpen }">帖子专区</h5>
          </RouterLink>
        </el-tooltip>
      </li>

 <li class="menuItem">
     <el-tooltip effect="dark" content="旅游攻略" placement="right">
          <RouterLink to="/ListofExperts" class="menuOption">
        <el-icon :size="25"><CirclePlus /></el-icon>
         <h5 class="menuText" :class="{ open2: isMenuOpen }">旅游攻略</h5>
          </RouterLink>
        </el-tooltip>
      </li>
        ...
        <el-tooltip effect="dark" content="消息" placement="right">
          <RouterLink to="/user/control">
            <div class="menuOption">
              ...
              <h5 class="menuText" :class="{ open2: isMenuOpen }">消息</h5>
            </div>
          </RouterLink>
        </el-tooltip>
      </li>---> 
  ...
  <el-dialog v-model="dialogFormVisible" title="更新个人信息" center draggable>
    <div class="fileUpload">
      <el-upload v-model:file-list="fileList"
                 ref="upload"
                 action="http://59.110.231.96:8000/user/avatar/"
                 :limit="1"
